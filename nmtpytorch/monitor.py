...
class Monitor:
    ...
    """
    # Variables to save
    VARS = ['uctr', 'ectr', 'vctr', 'early_bad', 'train_loss_G', 'train_loss_D', 'val_scores']
    ...
    def __init__(self, save_path, exp_id,
        ...
        self.train_loss_G = history.pop('train_loss_G', [])
        self.train_loss_D = history.pop('train_loss_D', [])
